...
$path = '../images/'.$file_name_new;
    ...
    if(@move_uploaded_file($_FILES['file']['tmp_name'], $path)) {
                ...
                $sql = "INSERT INTO agri_tips(description,region,user,type,name,qty,price,total,file,date_t)VALUES('$description','$region','$ruser','$type','$name','$qty','$Price','$total','$file_name_new','$date_t')";
