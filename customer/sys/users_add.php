    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <?php
                ...
                $sql = "INSERT INTO users(name,surname,username,password,type)VALUES('$name','$surname','$username','$password','regioner')";
                $results = mysqli_query($db,$sql);
                        ...
                        <a href="#" class="close" data-dismiss="alert">&times;</a>
                        <strong> Successfully! </strong><?php echo'Thank you for adding user ';?></div>
                        <?php
