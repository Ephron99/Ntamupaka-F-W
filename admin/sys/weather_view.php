...
<!--===============================================================================================-->
    ...
    <div class="wrapper">
        ...
        <?php  include_once ('page-headers.php'); ?>
            ...
            <p class="card-header sammac-media">All Oeders</p>    
            <div class="card-body">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                  ...
                  <a href="weather_view.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-succuss"><span class="fa fa-check"></span>Confirm</a>
                              </td>  
                          </tr>
                          <?php
