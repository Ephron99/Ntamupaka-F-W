     ...
     <div class="col-md-4">
      <div class="card-counter info">
        ...
        <span class="count-name">Customer Orders</span>
            ...
            <p class="card-header sammac-media">All Orders<a href="#"  style="margin-left: 100px;"> Pending</a>&nbsp;&nbsp;||<a href="orders_view2.php"  style=""> Paid</a>&nbsp;&nbsp;||<a href="#" style=""> Unpaid</a></p>  

            <div class="card-body" id="pagepanding">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                    ...
                    <?php
                     $a=1;
                    $query=mysqli_query($db,"select *from `orders` where type ='business' and status = 'Panding' ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['total'];?></td>
                             ...
                             <td>    
                  <a href="orders_view.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-close">Ignore</span></a>
                  <a href="orders_view.php?edited=1&idv=<?php echo $row['id'];  ?>"  class="btn btn-success"><span class="fa fa-check"></span>Confirm</a>
                              </td>  
                          </tr>
                          <?php
                      ...
                      {
                          $id = $_GET['idx'];
                          if ($stmt = $db->prepare("UPDATE orders SET status = 'Ignored' WHERE id = ? LIMIT 1"))
                          {
                   ...
                   <?php echo'Record Successfully Updated';?></div>
                   <script>
                       setTimeout(function () {
                        window.location.href = "orders_view.php";
                        }, 5000); 
                    ...
                    <?php
                      ...
                      {
                          $id = $_GET['idv'];
                          if ($stmt = $db->prepare("UPDATE orders SET status = 'confirmed' WHERE id = ? LIMIT 1"))
                          {
                              $stmt->bind_param("i",$id);
                              $stmt->execute();
                              $stmt->close();
