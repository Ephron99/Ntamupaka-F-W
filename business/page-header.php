...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: #00bd56; width: 100%; height: 80px;">
  ...
  <button type="submit"  class="btn btn-primary" >Search</button>
        ...
        <ul class="nav navbar-nav ml-auto" >
            ...
            <li class="nav-item">
                <a class="nav-link" href="business/login.php" class="fa fa-power-off" style="color: #fff;">Business Partiol</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="contact.php" class="fa fa-power-off" style="color: #fff;">CONTACT US</a>
            </li>
          <li class="nav-item">
               <a class="nav-link" href="customer/login.php" class="fa fa-power-off" style="color: #fff;">lOGIN</a>
            </li>
            <li class="nav-item">
               <a class="nav-link" href="report.php" style="color: #fff;"><button class="btn btn-dark" style="margin: -5px 5px 5px 5px;">View as Report</button></a>
            </li>
        </ul>
    </div>
    </div>
