            ...
            <div class="card-body">
              <div id="tabs-4"><table class="table table-striped thead-dark table-bordered table-hover" id="mhishi">
                ...
                <tr>
                    ...
                    <?php
                     $a=1;
                    $query=mysqli_query($db,"select *from `orders` where type = 'business' ");
                     while($row=mysqli_fetch_array($query))
                        {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row['Productname'];?></td>
                             ...
                             <td>    
                  <a href="weather_view.php?edited=1&idx=<?php echo $row['id']; ?>"  class="btn btn-danger"><span class="fa fa-close">Delete</span></a>
                  </td>  
                          </tr>
                          <?php
