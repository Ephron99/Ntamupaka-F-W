...
<body>
	...
	<div class="limiter" style="margin-top: 5px;">
		<div class="container-login100" style="background-image: url('images/header1.jpg'); margin-top: -60px; height: 50px;">
			<div class="wrap-login100 p-t-30 p-b-50">

				<span class="login100-form-title p-b-41">
					<h2>NTAMUPAKA FOOD WEB </h2>
					
					<a href="#" >
                 	<button class="btn btn-dark" style="margin: 10px 50px 5px 100px;">Who we are</button></a>
				</span>
...
<?php
    ...
    <div class="col">
      <center><h1 style="margin-top: 20px;">Business</h1></center>
    </div>
    
  </div>
       
  <div class="row row-cols-5 row-cols-lg-5 g-2 g-lg-3" style="margin:20px;">
  	<?php
                     $a=1;
